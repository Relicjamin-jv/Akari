...
//        System.setOut(stream);
        ...
        /**END OF THE 7x7 BOARD*/


        /**Start of the 6x6 board*/
...
//
//        System.out.println("The algo took " + duration6/1000000000.0);


        /**End of the 6x6 board*/


        /**Start of the second 7x7 board*/
...
//        }
        ...
        /**Start of the 8x8 board*/

//        Board board4 = new Board(8);
//        BoardSolver boardSolver4 = new BoardSolver(board4.board, 8, board4);
//
//        board4.placeWall(0,1,1);
//        board4.placeWall(0, 6, 0);
//        board4.placeWall(0, 7, 1);
//        board4.placeWall(2, 0,2);
//        board4.placeWall(2, 2, 2);
//        board4.placeWall(2, 5, 1);
//        board4.placeWall(2, 6, -1);
//        board4.placeWall(2, 7, -1);
//        board4.placeWall(3, 3, 1);
//        board4.placeWall(4, 7, -1);
//        board4.placeWall(0, 6, -1);
//        board4.placeWall(6,1, -1);
//        board4.placeWall(6,2, -1);
//        board4.placeWall(7, 7, 2);
//        board4.placeWall(6,0, -1);
//
//        board4.printBoard();
//
...
//        System.out.println("Took: " + (endTime - startTime)/1000000000.0);
        ...
        /**End of the 8X8 board*/


        /**Start of the 5x5 Board*/


//        Board board5 = new Board(5);
//        BoardSolver boardSolver5= new BoardSolver(board5.board, 5, board5);
//
//        board5.placeWall(1,3,-1);
//        board5.placeWall(2,0,1);
//        board5.placeWall(2,2,-1);
//        board5.placeWall(3,0,-1);
//        board5.placeWall(3,1,-1);
//        board5.placeWall(4,3,3);
//
//        //boardSolver5.preprocessor();
//        ArrayList<Board.Cell> candidates5 = new ArrayList<>();
//        for (int i = 0; i < board5.size; i++) {
//            for (int j = 0; j < board5.size; j++) {
//                if (!board5.getCell(i, j).getWall() && !board5.getCell(i, j).getBulb()) {
//                    candidates5.add(board5.getCell(i, j)); //add the cell to i, j
//                }
//            }
//        }
//        long timeStart = System.nanoTime();
//        candidates5 = hueristicSort(candidates5, board5);
//        for (int i = 0; i < candidates5.size(); i++) {
//            if(i > 0){
//                candidates5.remove(0);
//            }
//            boardSolver5.backTrackSolve(board5, candidates5);
//            board5.reset();
//            //boardSolver5.preprocessor(); //reset the preprocessed data
//        }
//        long timeEnd = System.nanoTime();
//
//        System.out.println("Took: " + (timeEnd - timeStart)/1000000000.0);

        /**End of the 5x5 Board*/

        /**Start of the 9X9 board*/
